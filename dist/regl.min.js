...
H[0].width;z.height=H[0].height;U(m);for(g=0;6>g;++g)t(H[g],34069+g);O(A,34067);ua();p.profile&&(m.stats.size=La(m.internalformat,m.type,z.width,z.height,A.genMipmaps,!0));z.format=ea[m.internalformat];z.type=M[m.type];z.mag=Ea[A.magFilter];z.min=na[A.minFilter];z.wrapS=oa[A.wrapS];z.wrapT=oa[A.wrapT];for(g=0;6>g;++g)wa(H[g]);return z}var m=new y(34067);fa[m.id]=m;d.cubeCount++;var H=Array(6);z(b,c,e,f,n,r);z.subimage=function(a,b,c,d,e){c|=0;d|=0;e|=0;var f=k();u(f,m);f.width=0;f.height=0;C(f,b);
f.width=f.width||(m.width>>e)-c;f.height=f.height||(m.height>>e)-d;U(m);q(f,34069+a,c,d,e);ua();g(f);return z};z.resize=function(b){b|=0;if(b!==m.width){z.width=m.width=b;z.height=m.height=b;U(m);for(var c=0;6>c;++c)for(var d=0;m.mipmask>>d;++d)a.texImage2D(34069+c,d,m.format,b>>d,b>>d,0,m.format,m.type,null);ua();p.profile&&(m.stats.size=La(m.internalformat,m.type,z.width,z.height,!1,!0));return z}};z._reglType="textureCube";z._texture=m;p.profile&&(z.stats=m.stats);z.destroy=function(){m.decRef()};
...
b){function c(a,b){var d,f=0,k=0,t=!0,h=!0;d=null;var n=!0,q="rgba",r="uint8",p=1,y=null,D=null,na=null,O=!1;if("number"===typeof a)f=a|0,k=b|0||f;else if(a){"shape"in a?(k=a.shape,f=k[0],k=k[1]):("radius"in a&&(f=k=a.radius),"width"in a&&(f=a.width),"height"in a&&(k=a.height));if("color"in a||"colors"in a)d=a.color||a.colors,Array.isArray(d);if(!d){"colorCount"in a&&(p=a.colorCount|0);"colorTexture"in a&&(n=!!a.colorTexture,q="rgba4");if("colorType"in a&&(r=a.colorType,!n))if("half float"===r||"float16"===
r)q="rgba16f";else if("float"===r||"float32"===r)q="rgba32f";"colorFormat"in a&&(q=a.colorFormat,0<=Ia.indexOf(q)?n=!0:0<=wa.indexOf(q)&&(n=!1))}if("depthTexture"in a||"depthStencilTexture"in a)O=!(!a.depthTexture&&!a.depthStencilTexture);"depth"in a&&("boolean"===typeof a.depth?t=a.depth:(y=a.depth,h=!1));"stencil"in a&&("boolean"===typeof a.stencil?h=a.stencil:(D=a.stencil,t=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?t=h=a.depthStencil:(na=a.depthStencil,h=t=!1))}else f=k=1;var W=
null,J=null,U=null,x=null;if(Array.isArray(d))W=d.map(v);else if(d)W=[v(d)];else for(W=Array(p),d=0;d<p;++d)W[d]=m(f,k,n,q,r);f=f||W[0].width;k=k||W[0].height;y?J=v(y):t&&!h&&(J=m(f,k,O,"depth","uint32"));D?U=v(D):h&&!t&&(U=m(f,k,!1,"stencil","uint8"));na?x=v(na):!y&&!D&&h&&t&&(x=m(f,k,O,"depth stencil","depth stencil"));t=null;for(d=0;d<W.length;++d)u(W[d],f,k),W[d]&&W[d].texture&&(h=Za[W[d].texture._texture.format]*Ra[W[d].texture._texture.type],null===t&&(t=h));u(J,f,k);u(U,f,k);u(x,f,k);g(e);
e.width=f;e.height=k;e.colorAttachments=W;e.depthAttachment=J;e.stencilAttachment=U;e.depthStencilAttachment=x;c.color=W.map(C);c.depth=C(J);c.stencil=C(U);c.depthStencil=C(x);c.width=e.width;c.height=e.height;l(e);return c}var e=new k;d.framebufferCount++;c(a,b);return N(c,{resize:function(a,b){var d=Math.max(a|0,1),f=Math.max(b|0||d,1);if(d===e.width&&f===e.height)return c;for(var g=e.colorAttachments,k=0;k<g.length;++k)q(g[k],d,f);q(e.depthAttachment,d,f);q(e.stencilAttachment,d,f);q(e.depthStencilAttachment,
...
else{for(var d=b.angle_instanced_arrays,e=0;e<q.length;++e){var f=q[e];f.buffer?(a.enableVertexAttribArray(e),f.buffer.bind(),a.vertexAttribPointer(e,f.size,f.type,f.normalized,f.stride,f.offfset),d&&f.divisor&&d.vertexAttribDivisorANGLE(e,f.divisor)):(a.disableVertexAttribArray(e),a.vertexAttrib4f(e,f.x,f.y,f.z,f.w))}p.elements?a.bindBuffer(34963,p.elements.buffer.buffer):a.bindBuffer(34963,null)}r.currentVAO=c}}function h(){K(g).forEach(function(a){a.destroy()})}function v(){this.id=++k;this.attributes=
[];this.elements=null;this.ownsElements=!1;this.offset=this.count=0;this.instances=-1;this.primitive=4;var a=b.oes_vertex_array_object;this.vao=a?a.createVertexArrayOES():null;g[this.id]=this;this.buffers=[]}function m(){b.oes_vertex_array_object&&K(g).forEach(function(a){a.refresh()})}var C=c.maxAttributes,q=Array(C);for(c=0;c<C;++c)q[c]=new $a;var k=0,g={},r={Record:$a,scope:{},state:q,currentVAO:null,targetVAO:null,restore:b.oes_vertex_array_object?m:function(){},createVAO:function(a){function b(a){var e;
...
b.id){a[c].location=b.location;return}a.push(b)}function p(c,d,e){e=35632===c?h:v;var f=e[d];if(!f){var m=b.str(d),f=a.createShader(c);a.shaderSource(f,m);a.compileShader(f);e[d]=f}return f}function n(a,b){this.id=q++;this.fragId=a;this.vertId=b;this.program=null;this.uniforms=[];this.attributes=[];this.refCount=1;e.profile&&(this.stats={uniformsCount:0,attributesCount:0})}function u(c,g,h){var l;l=p(35632,c.fragId);var m=p(35633,c.vertId);g=c.program=a.createProgram();a.attachShader(g,l);a.attachShader(g,
m);if(h)for(l=0;l<h.length;++l)m=h[l],a.bindAttribLocation(g,m[0],m[1]);a.linkProgram(g);m=a.getProgramParameter(g,35718);e.profile&&(c.stats.uniformsCount=m);var n=c.uniforms;for(l=0;l<m;++l)if(h=a.getActiveUniform(g,l))if(1<h.size)for(var q=0;q<h.size;++q){var u=h.name.replace("[0]","["+q+"]");d(n,new f(u,b.id(u),a.getUniformLocation(g,u),h))}else d(n,new f(h.name,b.id(h.name),a.getUniformLocation(g,h.name),h));m=a.getProgramParameter(g,35721);e.profile&&(c.stats.attributesCount=m);c=c.attributes;
for(l=0;l<m;++l)(h=a.getActiveAttrib(g,l))&&d(c,new f(h.name,b.id(h.name),a.getAttribLocation(g,h.name),h))}var h={},v={},m={},C=[],q=0;e.profile&&(c.getMaxUniformsCount=function(){var a=0;C.forEach(function(b){b.stats.uniformsCount>a&&(a=b.stats.uniformsCount)});return a},c.getMaxAttributesCount=function(){var a=0;C.forEach(function(b){b.stats.attributesCount>a&&(a=b.stats.attributesCount)});return a});return{clear:function(){var b=a.deleteShader.bind(a);K(h).forEach(b);h={};K(v).forEach(b);v={};
C.forEach(function(b){a.deleteProgram(b.program)});C.length=0;m={};c.shaderCount=0},program:function(b,d,e,f){var q=m[d];q||(q=m[d]={});var p=q[b];if(p&&(p.refCount++,!f))return p;var x=new n(d,b);c.shaderCount++;u(x,e,f);p||(q[b]=x);C.push(x);return N(x,{destroy:function(){x.refCount--;if(0>=x.refCount){a.deleteProgram(x.program);var b=C.indexOf(x);C.splice(b,1);c.shaderCount--}0>=q[x.vertId].refCount&&(a.deleteShader(v[x.vertId]),delete v[x.vertId],delete m[x.fragId][x.vertId]);Object.keys(m[x.fragId]).length||
(a.deleteShader(h[x.fragId]),delete h[x.fragId],delete m[x.fragId])}})},restore:function(){h={};v={};for(var a=0;a<C.length;++a)u(C[a],null,C[a].attributes.map(function(a){return[a.location,a.name]}))},shader:p,frag:-1,vert:-1}}function Ub(a,b,c,e,f,d,p){function n(d){var f;f=null===b.next?5121:b.next.colorAttachments[0].texture._texture.type;var m=0,n=0,q=e.framebufferWidth,k=e.framebufferHeight,g=null;Q(d)?g=d:d&&(m=d.x|0,n=d.y|0,q=(d.width||e.framebufferWidth-m)|0,k=(d.height||e.framebufferHeight-
n)|0,g=d.data||null);c();d=q*k*4;g||(5121===f?g=new Uint8Array(d):5126===f&&(g=g||new Float32Array(d)));a.pixelStorei(3333,4);a.readPixels(m,n,q,k,6408,f,g);return g}function u(a){var c;b.setFBO({framebuffer:a.framebuffer},function(){c=n(a)});return c}return function(a){return a&&"framebuffer"in a?u(a):n(a)}}function Aa(a){return Array.prototype.slice.call(a)}function Ba(a){return Aa(a).join("")}function Vb(){function a(){var a=[],b=[];return N(function(){a.push.apply(a,Aa(arguments))},{def:function(){var d=
"v"+c++;b.push(d);0<arguments.length&&(a.push(d,"="),a.push.apply(a,Aa(arguments)),a.push(";"));return d},toString:function(){return Ba([0<b.length?"var "+b.join(",")+";":"",Ba(a)])}})}function b(){function b(a,e){d(a,e,"=",c.def(a,e),";")}var c=a(),d=a(),e=c.toString,f=d.toString;return N(function(){c.apply(c,Aa(arguments))},{def:c.def,entry:c,exit:d,save:b,set:function(a,d,e){b(a,d);c(a,d,"=",e,";")},toString:function(){return e()+f()}})}var c=0,e=[],f=[],d=a(),p={};return{global:d,link:function(a){for(var b=
0;b<f.length;++b)if(f[b]===a)return e[b];b="g"+c++;e.push(b);f.push(a);return b},block:a,proc:function(a,c){function d(){var a="a"+e.length;e.push(a);return a}var e=[];c=c||0;for(var f=0;f<c;++f)d();var f=b(),C=f.toString;return p[a]=N(f,{arg:d,toString:function(){return Ba(["function(",e.join(),"){",C(),"}"])}})},scope:b,cond:function(){var a=Ba(arguments),c=b(),d=b(),e=c.toString,f=d.toString;return N(c,{then:function(){c.apply(c,Aa(arguments));return this},"else":function(){d.apply(d,Aa(arguments));
return this},toString:function(){var b=f();b&&(b="else{"+b+"}");return Ba(["if(",a,"){",e(),"}",b])}})},compile:function(){var a=['"use strict";',d,"return {"];Object.keys(p).forEach(function(b){a.push('"',b,'":',p[b].toString(),",")});a.push("}");var b=Ba(a).replace(/;/g,";\n").replace(/}/g,"}\n").replace(/{/g,"{\n");return Function.apply(null,e.concat(b)).apply(null,f)}}}function Sa(a){return Array.isArray(a)||Q(a)||ka(a)}function yb(a){return a.sort(function(a,c){return"viewport"===a?-1:"viewport"===
c?1:a<c?-1:1})}function L(a,b,c,e){this.thisDep=a;this.contextDep=b;this.propDep=c;this.append=e}function va(a){return a&&!(a.thisDep||a.contextDep||a.propDep)}function x(a){return new L(!1,!1,!1,a)}function M(a,b){var c=a.type;if(0===c)return c=a.data.length,new L(!0,1<=c,2<=c,b);if(4===c)return c=a.data,new L(c.thisDep,c.contextDep,c.propDep,b);if(5===c)return new L(!1,!1,!1,b);if(6===c){for(var e=c=!1,f=!1,d=0;d<a.data.length;++d){var p=a.data[d];1===p.type?f=!0:2===p.type?e=!0:3===p.type?c=!0:
0===p.type?(c=!0,p=p.data,1<=p&&(e=!0),2<=p&&(f=!0)):4===p.type&&(c=c||p.data.thisDep,e=e||p.data.contextDep,f=f||p.data.propDep)}return new L(c,e,f,b)}return new L(3===c,2===c,1===c,b)}function Wb(a,b,c,e,f,d,p,n,u,h,v,m,C,q,k){function g(a){return a.replace(".","_")}function r(a,b,c){var d=g(a);Na.push(a);Da[d]=ra[d]=!!c;sa[d]=b}function l(a,b,c){var d=g(a);Na.push(a);Array.isArray(c)?(ra[d]=c.slice(),Da[d]=c.slice()):ra[d]=Da[d]=c;ta[d]=b}function D(){var a=Vb(),c=a.link,d=a.global;a.id=qa++;a.batchId=
...
l.length&&(w[a]=l[b])})}else{var B=Sa(c.buffer)?f.getBuffer(f.create(c.buffer,34962,!1,!0)):f.getBuffer(c.buffer),k=c.offset|0,h=c.stride|0,m=c.size|0,q=!!c.normalized,n=0;"type"in c&&(n=Ja[c.type]);c=c.divisor|0;w.buffer=B;w.state=1;w.size=m;w.normalized=q;w.type=n||B.dtype;w.offset=k;w.stride=h;w.divisor=c}}g[a]=x(function(a,b){var c=a.attribCache;if(e in c)return c[e];var d={isStream:!1};Object.keys(w).forEach(function(a){d[a]=w[a]});w.buffer&&(d.buffer=a.link(w.buffer),d.type=d.type||d.buffer+
...
e,".normalized;");d("size");d("offset");d("stride");d("divisor");c("}}");c.exit("if(",B.isStream,"){",f,".destroyStream(",k,");","}");return B})});return g}function H(a){var b=a["static"],c=a.dynamic,d={};Object.keys(b).forEach(function(a){var c=b[a];d[a]=x(function(a,b){return"number"===typeof c||"boolean"===typeof c?""+c:a.link(c)})});Object.keys(c).forEach(function(a){var b=c[a];d[a]=M(b,function(a,c){return a.invoke(c,b)})});return d}function z(a,b,d,e,f){function l(a){var b=q[a];b&&(ba[a]=b)}
var k=Q(a,b),m=I(a,f),q=E(a,m,f),n=O(a,f),ba=y(a,f),p=J(a,f,k);l("viewport");l(g("scissor.box"));var Xb=0<Object.keys(ba).length,m={framebuffer:m,draw:n,shader:p,state:ba,dirty:Xb,scopeVAO:null,drawVAO:null,useVAO:!1,attributes:{}};m.profile=t(a,f);m.uniforms=U(d,f);m.drawVAO=m.scopeVAO=n.vao;if(!m.drawVAO&&p.program&&!k&&c.angle_instanced_arrays&&n["static"].elements){var r=!0;a=p.program.attributes.map(function(a){a=b["static"][a];r=r&&!!a;return a});if(r&&0<a.length){var v=h.getVAO(h.createVAO({attributes:a,
...
(a.instancing=b.def(a.shared.extensions,".angle_instanced_arrays"))}function G(a,b,c,d,e){function f(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function g(a){t=b.def();a(t,"=",f(),";");"string"===typeof e?a(m,".count+=",e,";"):a(m,".count++;");q&&(d?(r=b.def(),a(r,"=",p,".getNumPendingQueries();")):a(p,".beginQuery(",m,");"))}function l(a){a(m,".cpuTime+=",f(),"-",t,";");q&&(d?a(p,".pushScopeStats(",r,",",p,".getNumPendingQueries(),",m,");"):a(p,".endQuery();"))}function k(a){var c=
b.def(n,".profile");b(n,".profile=",a,";");b.exit(n,".profile=",c,";")}var h=a.shared,m=a.stats,n=h.current,p=h.timer;c=c.profile;var t,r;if(c){if(va(c)){c.enable?(g(b),l(b.exit),k("true")):k("false");return}c=c.append(a,b);k(c)}else c=b.def(n,".profile");h=a.block();g(h);b("if(",c,"){",h,"}");a=a.block();l(a);b.exit("if(",c,"){",a,"}")}function ha(a,b,c,d,e){function f(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;
default:return 1}}function g(c,d,e){function f(){b("if(!",n,".buffer){",h,".enableVertexAttribArray(",m,");}");var c=e.type,g;g=e.size?b.def(e.size,"||",d):d;b("if(",n,".type!==",c,"||",n,".size!==",g,"||",p.map(function(a){return n+"."+a+"!=="+e[a]}).join("||"),"){",h,".bindBuffer(",34962,",",q,".buffer);",h,".vertexAttribPointer(",[m,g,c,e.normalized,e.stride,e.offset],");",n,".type=",c,";",n,".size=",g,";",p.map(function(a){return n+"."+a+"="+e[a]+";"}).join(""),"}");X&&(c=e.divisor,b("if(",n,
".divisor!==",c,"){",a.instancing,".vertexAttribDivisorANGLE(",[m,c],");",n,".divisor=",c,";}"))}function k(){b("if(",n,".buffer){",h,".disableVertexAttribArray(",m,");",n,".buffer=null;","}if(",Ca.map(function(a,b){return n+"."+a+"!=="+da[b]}).join("||"),"){",h,".vertexAttrib4f(",m,",",da,");",Ca.map(function(a,b){return n+"."+a+"="+da[b]+";"}).join(""),"}")}var h=l.gl,m=b.def(c,".location"),n=b.def(l.attributes,"[",m,"]");c=e.state;var q=e.buffer,da=[e.x,e.y,e.z,e.w],p=["buffer","normalized","offset",
"stride"];1===c?f():2===c?k():(b("if(",c,"===",1,"){"),f(),b("}else{"),k(),b("}"))}var l=a.shared;d.forEach(function(d){var l=d.name,k=c.attributes[l],h;if(k){if(!e(k))return;h=k.append(a,b)}else{if(!e(Ab))return;var m=a.scopeAttrib(l);h={};Object.keys(new fa).forEach(function(a){h[a]=b.def(m,".",a)})}g(a.link(d),f(d.info.type),h)})}function R(a,c,d,e,f,g){for(var l=a.shared,k=l.gl,h,m=0;m<e.length;++m){var n=e[m],q=n.name,p=n.info.type,t=d.uniforms[q],n=a.link(n)+".location",r;if(t){if(!f(t))continue;
if(va(t)){q=t.value;if(35678===p||35680===p)p=a.link(q._texture||q.color[0]._texture),c(k,".uniform1i(",n,",",p+".bind());"),c.exit(p,".unbind();");else if(35674===p||35675===p||35676===p)q=a.global.def("new Float32Array(["+Array.prototype.slice.call(q)+"])"),t=2,35675===p?t=3:35676===p&&(t=4),c(k,".uniformMatrix",t,"fv(",n,",false,",q,");");else{switch(p){case 5126:h="1f";break;case 35664:h="2f";break;case 35665:h="3f";break;case 35666:h="4f";break;case 35670:h="1i";break;case 5124:h="1i";break;
case 35671:h="2i";break;case 35667:h="2i";break;case 35672:h="3i";break;case 35668:h="3i";break;case 35673:h="4i";break;case 35669:h="4i"}c(k,".uniform",h,"(",n,",",pa(q)?Array.prototype.slice.call(q):q,");")}continue}else r=t.append(a,c)}else{if(!f(Ab))continue;r=c.def(l.uniforms,"[",b.id(q),"]")}35678===p?c("if(",r,"&&",r,'._reglType==="framebuffer"){',r,"=",r,".color[0];","}"):35680===p&&c("if(",r,"&&",r,'._reglType==="framebufferCube"){',r,"=",r,".color[0];","}");q=1;switch(p){case 35678:case 35680:p=
c.def(r,"._texture");c(k,".uniform1i(",n,",",p,".bind());");c.exit(p,".unbind();");continue;case 5124:case 35670:h="1i";break;case 35667:case 35671:h="2i";q=2;break;case 35668:case 35672:h="3i";q=3;break;case 35669:case 35673:h="4i";q=4;break;case 5126:h="1f";break;case 35664:h="2f";q=2;break;case 35665:h="3f";q=3;break;case 35666:h="4f";q=4;break;case 35674:h="Matrix2fv";break;case 35675:h="Matrix3fv";break;case 35676:h="Matrix4fv"}if("M"===h.charAt(0)){c(k,".uniform",h,"(",n,",");var n=Math.pow(p-
35674+2,2),v=a.global.def("new Float32Array(",n,")");Array.isArray(r)?c("false,(",S(n,function(a){return v+"["+a+"]="+r[a]}),",",v,")"):c("false,(Array.isArray(",r,")||",r," instanceof Float32Array)?",r,":(",S(n,function(a){return v+"["+a+"]="+r+"["+a+"]"}),",",v,")");c(");")}else{if(1<q){for(var p=[],u=[],t=0;t<q;++t)Array.isArray(r)?u.push(r[t]):u.push(c.def(r+"["+t+"]")),g&&p.push(c.def());g&&c("if(!",a.batchId,"||",p.map(function(a,b){return a+"!=="+u[b]}).join("||"),"){",p.map(function(a,b){return a+
"="+u[b]+";"}).join(""));c(k,".uniform",h,"(",n,",",u.join(","),");")}else g&&(p=c.def(),c("if(!",a.batchId,"||",p,"!==",r,"){",p,"=",r,";")),c(k,".uniform",h,"(",n,",",r,");");g&&c("}")}}}function V(a,b,c,d){function e(f){var g=m[f];return g?g.contextDep&&d.contextDynamic||g.propDep?g.append(a,c):g.append(a,b):b.def(l,".",f)}function f(){function a(){c(v,".drawElementsInstancedANGLE(",[q,r,u,p+"<<(("+u+"-5121)>>1)",t],");")}function b(){c(v,".drawArraysInstancedANGLE(",[q,p,r,t],");")}n&&"null"!==
n?C?a():(c("if(",n,"){"),a(),c("}else{"),b(),c("}")):b()}function g(){function a(){c(k+".drawElements("+[q,r,u,p+"<<(("+u+"-5121)>>1)"]+");")}function b(){c(k+".drawArrays("+[q,p,r]+");")}n&&"null"!==n?C?a():(c("if(",n,"){"),a(),c("}else{"),b(),c("}")):b()}var h=a.shared,k=h.gl,l=h.draw,m=d.draw,n=function(){var e=m.elements,f=b;if(e){if(e.contextDep&&d.contextDynamic||e.propDep)f=c;e=e.append(a,f);m.elementsActive&&f("if("+e+")"+k+".bindBuffer(34963,"+e+".buffer.buffer);")}else e=f.def(),f(e,"=",
...
var tb={gl:a,context:C,strings:b,next:Da,current:ra,draw:m,elements:d,buffer:f,shader:v,attributes:h.state,vao:h,uniforms:u,framebuffer:n,extensions:c,timer:q,isBufferArgs:Sa},Pa={primTypes:Ka,compareFuncs:ab,blendFuncs:Fa,blendEquations:ga,stencilOps:Ta,glTypes:Ja,orientationType:zb};Ma&&(Pa.backBuffer=[1029],Pa.drawBuffer=S(e.maxDrawbuffers,function(a){return 0===a?[0]:S(a,function(a){return 36064+a})}));var qa=0;return{next:Da,current:ra,procs:function(){var a=D(),b=a.proc("poll"),d=a.proc("refresh"),
f=a.block();b(f);d(f);var g=a.shared,h=g.gl,l=g.next,k=g.current;f(k,".dirty=false;");T(a,b);T(a,d,null,!0);var m;X&&(m=a.link(X));c.oes_vertex_array_object&&d(a.link(c.oes_vertex_array_object),".bindVertexArrayOES(null);");for(var n=0;n<e.maxAttributes;++n){var q=d.def(g.attributes,"[",n,"]"),p=a.cond(q,".buffer");p.then(h,".enableVertexAttribArray(",n,");",h,".bindBuffer(",34962,",",q,".buffer.buffer);",h,".vertexAttribPointer(",n,",",q,".size,",q,".type,",q,".normalized,",q,".stride,",q,".offset);")["else"](h,
".disableVertexAttribArray(",n,");",h,".vertexAttrib4f(",n,",",q,".x,",q,".y,",q,".z,",q,".w);",q,".buffer=null;");d(p);X&&d(m,".vertexAttribDivisorANGLE(",n,",",q,".divisor);")}d(a.shared.vao,".currentVAO=null;",a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);");Object.keys(sa).forEach(function(c){var e=sa[c],g=f.def(l,".",c),m=a.block();m("if(",g,"){",h,".enable(",e,")}else{",h,".disable(",e,")}",k,".",c,"=",g,";");d(m);b("if(",g,"!==",k,".",c,"){",m,"}")});Object.keys(ta).forEach(function(c){var e=
ta[c],g=ra[c],m,n,q=a.block();q(h,".",e,"(");pa(g)?(e=g.length,m=a.global.def(l,".",c),n=a.global.def(k,".",c),q(S(e,function(a){return m+"["+a+"]"}),");",S(e,function(a){return n+"["+a+"]="+m+"["+a+"];"}).join("")),b("if(",S(e,function(a){return m+"["+a+"]!=="+n+"["+a+"]"}).join("||"),"){",q,"}")):(m=f.def(l,".",c),n=f.def(k,".",c),q(m,");",k,".",c,"=",m,";"),b("if(",m,"!==",n,"){",q,"}"));d(q)});return a.compile()}(),compile:function(a,b,c,d,e){var f=D();f.stats=f.link(e);Object.keys(b["static"]).forEach(function(a){aa(f,
...
f=a.getParameter(36063));var d=!!b.oes_texture_float;if(d){d=a.createTexture();a.bindTexture(3553,d);a.texImage2D(3553,0,6408,1,1,0,6408,5126,null);var p=a.createFramebuffer();a.bindFramebuffer(36160,p);a.framebufferTexture2D(36160,36064,3553,d,0);a.bindTexture(3553,null);if(36053!==a.checkFramebufferStatus(36160))d=!1;else{a.viewport(0,0,1,1);a.clearColor(1,0,0,1);a.clear(16384);var n=I.allocType(5126,4);a.readPixels(0,0,1,1,6408,5126,n);a.getError()?d=!1:(a.deleteFramebuffer(p),a.deleteTexture(d),
d=1===n[0]);I.freeType(n)}}n=!0;"undefined"!==typeof navigator&&(/MSIE/.test(navigator.userAgent)||/Trident\//.test(navigator.appVersion)||/Edge/.test(navigator.userAgent))||(n=a.createTexture(),p=I.allocType(5121,36),a.activeTexture(33984),a.bindTexture(34067,n),a.texImage2D(34069,0,6408,3,3,0,6408,5121,p),I.freeType(p),a.bindTexture(34067,null),a.deleteTexture(n),n=!a.getError());p=2===a.___regl_gl_version___;return{colorBits:[a.getParameter(3410),a.getParameter(3411),a.getParameter(3412),a.getParameter(3413)],
...
maxAttributes:a.getParameter(34921),maxVertexUniforms:a.getParameter(36347),maxVertexTextureUnits:a.getParameter(35660),maxVaryingVectors:a.getParameter(36348),maxFragmentUniforms:a.getParameter(36349),glsl:a.getParameter(35724),renderer:a.getParameter(7937),vendor:a.getParameter(7936),version:a.getParameter(7938),readFloat:d,npotTextureCube:n,webgl2Compat:p,npotMipmap:p}},Q=function(a){return a instanceof Uint8Array||a instanceof Uint16Array||a instanceof Uint32Array||a instanceof Int8Array||a instanceof
Int16Array||a instanceof Int32Array||a instanceof Float32Array||a instanceof Float64Array||a instanceof Uint8ClampedArray},K=function(a){return Object.keys(a).map(function(b){return a[b]})},Qa={shape:function(a){for(var b=[];a.length;a=a[0])b.push(a.length);return b},flatten:function(a,b,c,e){var f=1;if(b.length)for(var d=0;d<b.length;++d)f*=b[d];else f=0;c=e||I.allocType(c,f);switch(b.length){case 0:break;case 1:e=b[0];for(b=0;b<e;++b)c[b]=a[b];break;case 2:e=b[0];b=b[1];for(d=f=0;d<e;++d)for(var p=
a[d],n=0;n<b;++n)c[f++]=p[n];break;case 3:ib(a,b[0],b[1],b[2],c,0);break;default:jb(a,b,0,c,0)}return c}},Ha={"[object Int8Array]":5120,"[object Int16Array]":5122,"[object Int32Array]":5124,"[object Uint8Array]":5121,"[object Uint8ClampedArray]":5121,"[object Uint16Array]":5123,"[object Uint32Array]":5125,"[object Float32Array]":5126,"[object Float64Array]":5121,"[object ArrayBuffer]":5121},Ja={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126},nb={dynamic:35048,
stream:35040,"static":35044},Ua=Qa.flatten,mb=Qa.shape,ma=[];ma[5120]=1;ma[5122]=2;ma[5124]=4;ma[5121]=1;ma[5123]=2;ma[5125]=4;ma[5126]=4;var Ka={points:0,point:0,lines:1,line:1,triangles:4,triangle:4,"line loop":2,"line strip":3,"triangle strip":5,"triangle fan":6},pb=new Float32Array(1),Lb=new Uint32Array(pb.buffer),Pb=[9984,9986,9985,9987],Oa=[0,6409,6410,6407,6408],V={};V[6409]=V[6406]=V[6402]=1;V[34041]=V[6410]=2;V[6407]=V[35904]=3;V[6408]=V[35906]=4;var Xa=qa("HTMLCanvasElement"),Ya=qa("OffscreenCanvas"),
ub=qa("CanvasRenderingContext2D"),vb=qa("ImageBitmap"),wb=qa("HTMLImageElement"),xb=qa("HTMLVideoElement"),Mb=Object.keys(Ha).concat([Xa,Ya,ub,vb,wb,xb]),ya=[];ya[5121]=1;ya[5126]=4;ya[36193]=2;ya[5123]=2;ya[5125]=4;var E=[];E[32854]=2;E[32855]=2;E[36194]=2;E[34041]=4;E[33776]=.5;E[33777]=.5;E[33778]=1;E[33779]=1;E[35986]=.5;E[35987]=1;E[34798]=1;E[35840]=.5;E[35841]=.25;E[35842]=.5;E[35843]=.25;E[36196]=.5;var R=[];R[32854]=2;R[32855]=2;R[36194]=2;R[33189]=2;R[36168]=1;R[34041]=4;R[35907]=4;R[34836]=
16;R[34842]=8;R[34843]=6;var $b=function(a,b,c,e,f){function d(a){this.id=h++;this.refCount=1;this.renderbuffer=a;this.format=32854;this.height=this.width=0;f.profile&&(this.stats={size:0})}function p(b){var c=b.renderbuffer;a.bindRenderbuffer(36161,null);a.deleteRenderbuffer(c);b.renderbuffer=null;b.refCount=0;delete v[b.id];e.renderbufferCount--}var n={rgba4:32854,rgb565:36194,"rgb5 a1":32855,depth:33189,stencil:36168,"depth stencil":34041};b.ext_srgb&&(n.srgba=35907);b.ext_color_buffer_half_float&&
(n.rgba16f=34842,n.rgb16f=34843);b.webgl_color_buffer_float&&(n.rgba32f=34836);var u=[];Object.keys(n).forEach(function(a){u[n[a]]=a});var h=0,v={};d.prototype.decRef=function(){0>=--this.refCount&&p(this)};f.profile&&(e.getTotalRenderbufferSize=function(){var a=0;Object.keys(v).forEach(function(b){a+=v[b].stats.size});return a});return{create:function(b,c){function h(b,c){var d=0,e=0,m=32854;"object"===typeof b&&b?("shape"in b?(e=b.shape,d=e[0]|0,e=e[1]|0):("radius"in b&&(d=e=b.radius|0),"width"in
b&&(d=b.width|0),"height"in b&&(e=b.height|0)),"format"in b&&(m=n[b.format])):"number"===typeof b?(d=b|0,e="number"===typeof c?c|0:d):b||(d=e=1);if(d!==k.width||e!==k.height||m!==k.format)return h.width=k.width=d,h.height=k.height=e,k.format=m,a.bindRenderbuffer(36161,k.renderbuffer),a.renderbufferStorage(36161,m,d,e),f.profile&&(k.stats.size=R[k.format]*k.width*k.height),h.format=u[k.format],h}var k=new d(a.createRenderbuffer());v[k.id]=k;e.renderbufferCount++;h(b,c);h.resize=function(b,c){var d=
b|0,e=c|0||d;if(d===k.width&&e===k.height)return h;h.width=k.width=d;h.height=k.height=e;a.bindRenderbuffer(36161,k.renderbuffer);a.renderbufferStorage(36161,k.format,d,e);f.profile&&(k.stats.size=R[k.format]*k.width*k.height);return h};h._reglType="renderbuffer";h._renderbuffer=k;f.profile&&(h.stats=k.stats);h.destroy=function(){k.decRef()};return h},clear:function(){K(v).forEach(p)},restore:function(){K(v).forEach(function(b){b.renderbuffer=a.createRenderbuffer();a.bindRenderbuffer(36161,b.renderbuffer);
...
"constant color":32769,"one minus constant color":32770,"constant alpha":32771,"one minus constant alpha":32772,"src alpha saturate":776},ab={never:512,less:513,"<":513,equal:514,"=":514,"==":514,"===":514,lequal:515,"<=":515,greater:516,">":516,notequal:517,"!=":517,"!==":517,gequal:518,">=":518,always:519},Ta={0:0,zero:0,keep:7680,replace:7681,increment:7682,decrement:7683,"increment wrap":34055,"decrement wrap":34056,invert:5386},zb={cw:2304,ccw:2305},Ab=new L(!1,!1,!1,function(){}),ac=function(a,
b){function c(){this.endQueryIndex=this.startQueryIndex=-1;this.sum=0;this.stats=null}function e(a,b,d){var e=p.pop()||new c;e.startQueryIndex=a;e.endQueryIndex=b;e.sum=0;e.stats=d;n.push(e)}if(!b.ext_disjoint_timer_query)return null;var f=[],d=[],p=[],n=[],u=[],h=[];return{beginQuery:function(a){var c=f.pop()||b.ext_disjoint_timer_query.createQueryEXT();b.ext_disjoint_timer_query.beginQueryEXT(35007,c);d.push(c);e(d.length-1,d.length,a)},endQuery:function(){b.ext_disjoint_timer_query.endQueryEXT(35007)},
pushScopeStats:e,update:function(){var a,c;a=d.length;if(0!==a){h.length=Math.max(h.length,a+1);u.length=Math.max(u.length,a+1);u[0]=0;var e=h[0]=0;for(c=a=0;c<d.length;++c){var q=d[c];b.ext_disjoint_timer_query.getQueryObjectEXT(q,34919)?(e+=b.ext_disjoint_timer_query.getQueryObjectEXT(q,34918),f.push(q)):d[a++]=q;u[c+1]=e;h[c+1]=a}d.length=a;for(c=a=0;c<n.length;++c){var e=n[c],k=e.startQueryIndex,q=e.endQueryIndex;e.sum+=u[q]-u[k];k=h[k];q=h[q];q===k?(e.stats.gpuTime+=e.sum/1E6,p.push(e)):(e.startQueryIndex=
k,e.endQueryIndex=q,n[a++]=e)}n.length=a}},getNumPendingQueries:function(){return d.length},clear:function(){f.push.apply(f,d);for(var a=0;a<f.length;a++)b.ext_disjoint_timer_query.deleteQueryEXT(f[a]);d.length=0;f.length=0},restore:function(){d.length=0;f.length=0}}};return function(a){function b(){if(0===G.length)t&&t.update(),ea=null;else{ea=bb.next(b);v();for(var a=G.length-1;0<=a;--a){var c=G[a];c&&c(J,null,0)}q.flush();t&&t.update()}}function c(){!ea&&0<G.length&&(ea=bb.next(b))}function e(){ea&&
(bb.cancel(b),ea=null)}function f(a){a.preventDefault();e();S.forEach(function(a){a()})}function d(a){q.getError();g.restore();H.restore();y.restore();z.restore();Q.restore();T.restore();M.restore();t&&t.restore();K.procs.refresh();c();V.forEach(function(a){a()})}function p(a){function b(a,c){var d={},e={};Object.keys(a).forEach(function(b){var f=a[b];if(Y.isDynamic(f))e[b]=Y.unbox(f,b);else{if(c&&Array.isArray(f))for(var g=0;g<f.length;++g)if(Y.isDynamic(f[g])){e[b]=Y.unbox(f,b);return}d[b]=f}});
return{dynamic:e,"static":d}}function c(a){for(;n.length<a;)n.push(null);return n}var d=b(a.context||{},!0),e=b(a.uniforms||{},!0),f=b(a.attributes||{},!1);a=b(function(a){function b(a){if(a in c){var d=c[a];delete c[a];Object.keys(d).forEach(function(b){c[a+"."+b]=d[b]})}}var c=N({},a);delete c.uniforms;delete c.attributes;delete c.context;delete c.vao;"stencil"in c&&c.stencil.op&&(c.stencil.opBack=c.stencil.opFront=c.stencil.op,delete c.stencil.op);b("blend");b("depth");b("cull");b("stencil");b("polygonOffset");
b("scissor");b("sample");"vao"in a&&(c.vao=a.vao);return c}(a),!1);var g={gpuTime:0,cpuTime:0,count:0},h=K.compile(a,f,e,d,g),k=h.draw,l=h.batch,m=h.scope,n=[];return N(function(a,b){var d;if("function"===typeof a)return m.call(this,null,a,0);if("function"===typeof b)if("number"===typeof a)for(d=0;d<a;++d)m.call(this,null,b,d);else if(Array.isArray(a))for(d=0;d<a.length;++d)m.call(this,a[d],b,d);else return m.call(this,a,b,0);else if("number"===typeof a){if(0<a)return l.call(this,c(a|0),a|0)}else if(Array.isArray(a)){if(a.length)return l.call(this,
a,a.length)}else return k.call(this,a)},{stats:g,destroy:function(){h.destroy()}})}function n(a,b){var c=0;K.procs.poll();var d=b.color;d&&(q.clearColor(+d[0]||0,+d[1]||0,+d[2]||0,+d[3]||0),c|=16384);"depth"in b&&(q.clearDepth(+b.depth),c|=256);"stencil"in b&&(q.clearStencil(b.stencil|0),c|=1024);q.clear(c)}function u(a){G.push(a);c();return{cancel:function(){function b(){var a=Bb(G,b);G[a]=G[G.length-1];--G.length;0>=G.length&&e()}var c=Bb(G,a);G[c]=b}}}function h(){var a=R.viewport,b=R.scissor_box;
a[0]=a[1]=b[0]=b[1]=0;J.viewportWidth=J.framebufferWidth=J.drawingBufferWidth=a[2]=b[2]=q.drawingBufferWidth;J.viewportHeight=J.framebufferHeight=J.drawingBufferHeight=a[3]=b[3]=q.drawingBufferHeight}function v(){J.tick+=1;J.time=x();h();K.procs.poll()}function m(){z.refresh();h();K.procs.refresh();t&&t.update()}function x(){return(Cb()-I)/1E3}a=Hb(a);if(!a)return null;var q=a.gl,k=q.getContextAttributes();q.isContextLost();var g=Ib(q,a);if(!g)return null;var r=Eb(),l={vaoCount:0,bufferCount:0,elementsCount:0,
framebufferCount:0,shaderCount:0,textureCount:0,cubeCount:0,renderbufferCount:0,maxTextureUnits:0},D=g.extensions,t=ac(q,D),I=Cb(),E=q.drawingBufferWidth,L=q.drawingBufferHeight,J={tick:0,time:0,viewportWidth:E,viewportHeight:L,framebufferWidth:E,framebufferHeight:L,drawingBufferWidth:E,drawingBufferHeight:L,pixelRatio:a.pixelRatio},E={elements:null,primitive:4,count:-1,offset:0,instances:-1},O=Zb(q,D),y=Jb(q,l,a,function(a){return M.destroyBuffer(a)}),U=Kb(q,D,y,l),M=Sb(q,D,O,l,y,U,E),H=Tb(q,r,l,
a),z=Nb(q,D,O,function(){K.procs.poll()},J,l,a),Q=$b(q,D,O,l,a),T=Rb(q,D,O,z,Q,l),K=Wb(q,r,D,O,y,U,z,T,{},M,H,E,J,t,a),r=Ub(q,T,K.procs.poll,J,k,D,O),R=K.next,P=q.canvas,G=[],S=[],V=[],Z=[a.onDestroy],ea=null;P&&(P.addEventListener("webglcontextlost",f,!1),P.addEventListener("webglcontextrestored",d,!1));var aa=T.setFBO=p({framebuffer:Y.define.call(null,1,"framebuffer")});m();k=N(p,{clear:function(a){if("framebuffer"in a)if(a.framebuffer&&"framebufferCube"===a.framebuffer_reglType)for(var b=0;6>b;++b)aa(N({framebuffer:a.framebuffer.faces[b]},
